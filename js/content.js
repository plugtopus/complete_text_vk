...
function l(code) {
    var lang = {
        ...
        'help': 'Настройки',
        'h1': 'Расширение поможет Вам оказывать поддержку пользователей через сообщения ВКонтакте или упростит общение с друзьями.',
...
function appendMenuTo(href, input) {
    ...
    //         <a class="ui_actions_menu_item _im_settings_action" data-action="spam">????</a>
    //         <a class="ui_actions_menu_item _im_settings_action" data-action="sound">????????? ???????? ???????????</a>
    //     <a class="ui_actions_menu_item _im_settings_action" data-action="browser">???????? ?????????? ? ????????</a>
    //     <a class="ui_actions_menu_item" href="/al_im.php?act=a_switch_interface&amp;hash=ef709a15da9853d840&amp;type=classic">??????? ? ???????????? ?????????</a>
    //     </div></div></div>
